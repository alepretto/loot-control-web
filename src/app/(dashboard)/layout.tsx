...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        {/* Logo + collapse */}
        <div className="px-3 py-4 border-b border-border flex items-center justify-between gap-2 min-w-0">
          <Link href="/summary" className="flex items-center gap-2.5 min-w-0">
            <Image src="/nav-icon.png" alt="Loot Control" width={32} height={32} className="rounded-lg shrink-0" />
            {!collapsed && (
              <span className="text-sm font-semibold text-text-primary leading-tight truncate tracking-tight">
                Loot Control
              </span>
            )}
          </Link>
          <button
            ...
            className="text-muted hover:text-text-primary transition-colors shrink-0 p-0.5 rounded hover:bg-surface-2"
